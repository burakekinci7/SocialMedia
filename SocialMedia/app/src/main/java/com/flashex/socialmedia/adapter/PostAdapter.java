package com.flashex.socialmedia.adapter;
...
import com.flashex.socialmedia.databinding.RecyclerRowBinding;
...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.PostHolder> {
    ...
    public void onBindViewHolder(@NonNull PostHolder holder, int position) {
        ...
        Picasso.get().load(postArrayList.get(position).downloadUri).into(holder.recyclerRowBinding.recyclerViewImageView);
    }
